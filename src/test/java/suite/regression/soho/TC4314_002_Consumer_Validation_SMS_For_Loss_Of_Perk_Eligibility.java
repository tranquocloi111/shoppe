...
public class TC4314_002_Consumer_Validation_SMS_For_Loss_Of_Perk_Eligibility extends BaseTest{
    ...
    //include 5016
    @Test(enabled = true, description = "TC4314_002_Consumer_Validation_SMS_For_Loss_Of_Perk_Eligibility", groups = "SOHO")
    public void TC4314_002_Consumer_Validation_SMS_For_Loss_Of_Perk_Eligibility() {
        test.get().info("Step 1 :  Consumer customer that has multi subs");
        OWSActions owsActions = new OWSActions();
        String path = "src\\test\\resources\\xml\\soho\\TC4314_4505_request_consumer_type.xml";
        ...
        Assert.assertEquals(myAlert.getAllMessage().get(0), "As you’ve only got one eligible subscription on your account you’ll no longer get Family Perks. Click here for more info.");
    }
    ...
    private void verifyAdHocSMSMessagesIsSentInDatabase() {
        ...
        String mess = String.format("<SMSREQUEST><MPN>%s</MPN><BODY>Tesco Mobile: The number of subscriptions on your account has dropped to 1 so next month we'll remove your family perk.</BODY></SMSREQUEST>", subNo1);
