...
public class TC4500_001_Business_Customer_Including_Business_Name_Has_Been_Deactivated_In_24_Months_Ago extends BaseTest{
    private String customerNumber = "12167";
    private Date newStartDate;
    private String subNo1 = "07802273780";
    ...
    //include HTM-4520
    @Test(enabled = true, description = "TC4500_001_Business_Customer_Including_Business_Name_Has_Been_Deactivated_In_24_Months_Ago", groups = "SOHO")
    public void TC4500_001_Business_Customer_Including_Business_Name_Has_Been_Deactivated_In_24_Months_Ago() {
        test.get().info("Step 1 :  Business customer one of them is Inactivated");
        ...
        test.get().info("Step 10 : Submit Anonymise Acount Job");
        ...
        test.get().info("Step 12 : Verify color and information of business information tab ");
        ...
        test.get().info("Step 16 : Verify Find Order Request");
        ...
        test.get().info("Step 17 : Verify Get Account Auth Request");
        ...
        test.get().info("Step 18 : Verify Get Customer Request");
