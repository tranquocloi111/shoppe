...
public class TC4617_TC002_WS_02_Customer_Has_1_Subscription_That_Has_1_Permitted_And_Additional_Bundle extends BaseTest {
    ...
    @Test(enabled = true, description = "TC4617_TC002_WS_02_Customer_Has_1_Subscription_That_Has_1_Permitted_And_Additional_Bundle", groups = "Tropicana")
    public void TC4617_TC002_WS_02_Customer_Has_1_Subscription_That_Has_1_Permitted_And_Additional_Bundle() {
        test.get().info("Step 1 : Create a Customer has 1 Subscription that has 1 Permitted/Additional Bundle (Bonus Bundle Group associated with tariff)");
        ...
        Xml xml = swsActions.submitMaintainBundleRequest(selfCarePath, customerNumber, subscriptionNumber);
        Assert.assertTrue(xml.getTextByTagName("description").contains("Maintain Bundle request successful"));

        test.get().info("Step 8 : Locate test customer/subscription in GetBundle and run request");
        xml = swsActions.submitGetBundleRequest(customerNumber, subscriptionNumber);

        test.get().info("Step 9 : Verify get bundle response are correct");
    ...
    private void verifyGetBundleResponseAreCorrect(Xml xml){
        ...
        String file =  Common.readFile("src\\test\\resources\\xml\\tropicana\\TC4617_TC002_response.xml")
