...
public class TC5004_Care_View_Sub_Validation_For_New_Bonus_Bundle_In_Change_Family_Perk extends BaseTest {
    ...
    public void TC5004_Care_View_Sub_Validation_For_New_Bonus_Bundle_In_Change_Family_Perk(){
        ...
        test.get().info("Step 8 : Select FC mobile to change permitted bundle");
        String fcSubText = Common.findValueOfStream(subList, "Mobile Ref 2");
        ServiceOrdersPage.SelectSubscription.getInstance().selectSubscription(fcSubText, "Change Family Perk");

        test.get().info("Step 9 : Observe the Current Bundle section");
