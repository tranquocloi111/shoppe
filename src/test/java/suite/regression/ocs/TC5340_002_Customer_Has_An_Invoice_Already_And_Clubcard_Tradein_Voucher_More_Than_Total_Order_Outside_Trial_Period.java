...
public class TC5340_002_Customer_Has_An_Invoice_Already_And_Clubcard_Tradein_Voucher_More_Than_Total_Order_Outside_Trial_Period extends BaseTest {
    private String customerNumber = "47764647";
    ...
    @Test(enabled = false, description = "TC5340_002_Customer_Has_An_Invoice_Already_And_Clubcard_Tradein_Voucher_More_Than_Total_Order_Outside_Trial_Period", groups = "OCS")
    public void TC5340_002_Customer_Has_An_Invoice_Already_And_Clubcard_Tradein_Voucher_More_Than_Total_Order_Outside_Trial_Period() {
        ...
        newStartDate = TimeStamp.TodayMinus35Days();
        ...
        ServiceOrdersPage.DeactivateSubscriptionPage.getInstance().deactivateSubscriptionWithoutEtc(true);
        ...
        Date endDate = Parser.asDate(TimeStamp.Today().toLocalDate().minusDays(10));
