...
public class TC4976_Ows_CSA_Hub_Ps_Is_Both_Or_Mig_And_Ocs_Is_Hpin_And_Tariff_Ps_Is_Hpin extends BaseTest {
    ...
    @Test(enabled = true, description = "TC4976_Ows_CSA_Hub_Ps_Is_Both_Or_Mig_And_Ocs_Is_Hpin_And_Tariff_Ps_Is_Hpin", groups = "OCS")
    public void TC4976_Ows_CSA_Hub_Ps_Is_Both_Or_Mig_And_Ocs_Is_Hpin_And_Tariff_Ps_Is_Hpin() {
        test.get().info("Step 1 : New Customer, New SIM Only Order - System PS=BOTH or MIG, OWS PSF=HPIN& Tariff PS=HPIN ");
        CommonActions.updateHubProvisionSystem("B");
        OWSActions owsActions = new OWSActions();
        String path = "src\\test\\resources\\xml\\ocs\\TC4976_Care_CSA_Hpin_Request.xml";
    ...
    private void verifyGetOrderRequestAreCorrect(Xml xml){
        ...
        String file =  Common.readFile("src\\test\\resources\\xml\\ocs\\TC4976_Get_Order_Response.xml")
