...
public class TC33953_CCA_Paid_and_Remaining_Balance_PDF_Document extends BaseTest {
    String customerNumber ;
    String agreementNO;

    @Test(enabled = true, description = "TC33953 CCA paid and remaining balance PDF document", groups = "SelfCare")
    public void TC33953_CCA_Paid_and_Remaining_Balance_PDF_Document() {
        ...
        test.get().info("Step 7: verify agreement credit is created");
    ...
    private void verifyStatementToDatePDF() {
        ...
        MyPersonalInformationPage.MyTariffPage.MyTariffDetailsPage.getInstance("Mobile 1").setCreditAgreementSelectByVisibleText("What you've paid and your remaining balance");
        MyPersonalInformationPage.MyTariffPage.MyTariffDetailsPage.getInstance("Mobile 1").clickViewAgreementButton(0);
        String fileName = String.format("%s_%s_%s_mobile1.pdf", "33953", RandomCharacter.getRandomNumericString(9), customerNumber);
