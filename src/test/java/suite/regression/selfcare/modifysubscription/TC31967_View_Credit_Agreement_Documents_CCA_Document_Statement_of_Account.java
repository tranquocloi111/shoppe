...
public class TC31967_View_Credit_Agreement_Documents_CCA_Document_Statement_of_Account extends BaseTest {
    ...
    public void TC31967_View_Credit_Agreement_Documents_CCA_Document_Statement_of_Account() {
        ...
        test.get().info("Step 7: Upgrade FC 3 and accept upgrade");
        owsActions.upgradeFC3AndAcceptUpgrade(customerNumber, subno3);

        test.get().info("Step 8: Load customer in hub net");
        CareTestBase.page().loadCustomerInHubNet(customerNumber);

        test.get().info("Step 9: get CCA  no for new upgraded credit agreement of mobile FC3");
        ...
        test.get().info("Step 10: Deactivate FC 4 Subscription");
        deactiveFC4Subscription();

        test.get().info("Step 11: Login in to selfcare");
        SelfCareTestBase.page().LoginIntoSelfCarePage(owsActions.username, owsActions.password, customerNumber);

        test.get().info("Step 12: verify the statement to date pdf of FC1");
        verifyStatementToDatePDFOfFC1();

        test.get().info("Step 13: verify the statement to date pdf of FC2");
        verifyStatementToDatePDFOfFC2();

        test.get().info("Step 14: verify the statement to date pdf of FC3");
        verifyStatementToDatePDFOfFC3();

        test.get().info("Step 15: verify the statement to date pdf of FC4");
