...
public class TC33308_Self_Care_View_Bills_and_Payments extends BaseTest {
    ...
    public void TC33308_Self_Care_View_Bills_and_Payments() {
        ...
        test.get().info("Step 3: Access view details of my bills and payments link");
        ...
        test.get().info("Step 4: verify my bills and payments details page result display correctly");
