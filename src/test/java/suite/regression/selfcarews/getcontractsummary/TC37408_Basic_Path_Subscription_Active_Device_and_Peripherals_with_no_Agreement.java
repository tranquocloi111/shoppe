package suite.regression.selfcarews.getcontractsummary;
...
public class TC37408_Basic_Path_Subscription_Active_Device_and_Peripherals_with_no_Agreement extends BaseTest {
    ...
    @Test(enabled = true, description = "TC37408_Basic Path Subscription Active Device and Peripherals with no Agreement", groups = "SelfCareWS.GetContractSummary")
