package suite.regression.selfcarews.getusagesummary;
...
public class TC78_Self_Care_WS_Get_Usage_Summary extends BaseTest {
    ...
    @Test(enabled = true, description = "TC78 Self Care WS Get Usage Summary", groups = "SelfCareWS.GetUsageSummary")
