...
import logic.business.entities.ReceiptAllocation;
...
public class TC32670_Basic_Path_Adhoc_Payment_Existing_Card_Existing_Card_Match extends BaseTest {
    String customerNumber;
    String financialTransactionContentRef;

    @Test(enabled = true, description = "TC32670 basic path adhoc payment existing card existing card match", groups = "SelfCareWS.Payment")
    public void TC32670_Basic_Path_Adhoc_Payment_Existing_Card_Existing_Card_Match() {
        ...
        HashMap<String, String> financialTransaction = FinancialTransactionEnity.dataFinancialTransactionForMakeAOneOffPayment("Ad Hoc Payment", "£19.00");
        ...
        Assert.assertEquals("19", TasksContentPage.TaskPage.DetailsPage.getInstance().getAmountToBeDebited());
