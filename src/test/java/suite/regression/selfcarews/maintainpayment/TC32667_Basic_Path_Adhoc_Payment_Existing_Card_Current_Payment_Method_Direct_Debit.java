...
public class TC32667_Basic_Path_Adhoc_Payment_Existing_Card_Current_Payment_Method_Direct_Debit extends BaseTest {
    ...
    public void verifyAdHocPaymentTransactionDetail() {
        ...
        Assert.assertEquals(PaymentDetailPage.ReceiptDetail.getInstance().getCardType(), "Maestro");
