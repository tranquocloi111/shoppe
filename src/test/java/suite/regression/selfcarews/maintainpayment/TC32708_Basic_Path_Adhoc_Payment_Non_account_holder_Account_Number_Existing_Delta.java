...
public class TC32708_Basic_Path_Adhoc_Payment_Non_account_holder_Account_Number_Existing_Delta extends BaseTest {
    ...
    public void TC32708_Basic_Path_Adhoc_Payment_Non_account_holder_Account_Number_Existing_Delta() {
        ...
        HashMap<String, String> financialTransaction = FinancialTransactionEnity.dataFinancialTransactionForMakeAOneOffPayment("Ad Hoc Payment", "£13.00");
