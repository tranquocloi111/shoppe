 ...
 * Date: 17/09/2019
 */
public class TC32067_Basic_Path_Billing_Detail_Invoice_Stype_with_VAT extends BaseTest {
    String billingGroupName;
    String subscriptionNumber;
    String addressee;
    String email;

    @Test(enabled = true, description = "TC32067_Basic Path Billing Detail Invoice Stype with VAT", groups = "SelfCareWS")
    public void TC32067_Basic_Path_Billing_Detail_Invoice_Stype_with_VAT() {
