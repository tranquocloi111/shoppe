 ...
 * Date: 8/10/2019
 */
public class TC32256_Self_Care_WS_Get_Invoice_Draft_Invoice extends BaseTest {
    String invoiceNumber;
    private Date newStartDate = TimeStamp.TodayMinus20Days();

    @Test(enabled = true, description = "TC32256_Self_Care_WS_Get_Invoice_Draft_Invoice", groups = "SelfCareWS.GetInvoice")
    public void TC32256_Self_Care_WS_Get_Invoice_Draft_Invoice() {
        ...
        Xml response = swsActions.submitGetInvoiceWithAccountNoAndInvoiceNoRequest(customerNumber, invoiceNumber);
