 ...
 * Date: 9/08/2019
 */
public class TC32191_Self_Care_WS_Subscription_is_Active_Permitted_Bundle extends BaseTest {
    private String customerNumber;
    private Date newStartDate = TimeStamp.TodayMinus20Days();
    private String subscriptionNumber;

    @Test(enabled = true, description = "TC32191 Self Care WS Subscription is Active Permitted Bundle", groups = "SelfCareWS.GetBundle")
    public void TC32191_Self_Care_WS_Subscription_is_Active_Permitted_Bundle(){
        ...
        String sampleResponseFile = "src\\test\\resources\\xml\\sws\\getbundle\\TC32191_response.xml";
